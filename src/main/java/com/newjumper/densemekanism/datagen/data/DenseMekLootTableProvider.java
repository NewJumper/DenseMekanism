...
public class DenseMekLootTableProvider extends LootTableProvider {
    public DenseMekLootTableProvider(PackOutput pOutput) {
        super(pOutput, BuiltInLootTables.all(), List.of(new LootTableProvider.SubProviderEntry(DenseBlockLoot::new, LootContextParamSets.BLOCK)));
    }
