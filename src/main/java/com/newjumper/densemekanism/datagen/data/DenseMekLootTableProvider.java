...
public class DenseMekLootTableProvider extends LootTableProvider {
    private final List<Pair<Supplier<Consumer<BiConsumer<ResourceLocation, LootTable.Builder>>>, LootContextParamSet>> lootTables = ImmutableList.of(Pair.of(DenseMekLootTables::new, LootContextParamSets.BLOCK));

    public DenseMekLootTableProvider(DataGenerator gen) {
        super(gen);
    }
