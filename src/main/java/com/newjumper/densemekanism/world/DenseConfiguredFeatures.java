...
public class DenseConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_DENSE_FLUORITE = create("ore_dense_fluorite");
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_DENSE_FLUORITE_BURIED = create("ore_dense_fluorite_buried");
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_DENSE_LEAD = create("ore_dense_lead");
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_DENSE_OSMIUM_UPPER = create("ore_dense_osmium_upper");
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_DENSE_OSMIUM_MIDDLE = create("ore_dense_osmium_middle");
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_DENSE_OSMIUM_SMALL = create("ore_dense_osmium_small");
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_DENSE_TIN_SMALL = create("ore_dense_tin_small");
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_DENSE_TIN_LARGE = create("ore_dense_tin_large");
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_DENSE_URANIUM_BURIED = create("ore_dense_uranium_buried");
    public static final ResourceKey<ConfiguredFeature<?, ?>> ORE_DENSE_URANIUM_SMALL = create("ore_dense_uranium_small");
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> create(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.fromNamespaceAndPath(DenseMekanism.MOD_ID, name));
    }
}
